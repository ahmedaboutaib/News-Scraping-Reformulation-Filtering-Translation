...
def get_titles_urls(driver, date_format):
    ...
    try:
        ...
        driver.get("https://www.bladi.net/maroc.html")
        # Attendre que les éléments se chargent
        articles = WebDriverWait(driver, 30).until(EC.presence_of_all_elements_located((By.CSS_SELECTOR, "body > div.bt div div a")))
...
def get_article_info(url, driver, date_format):
    ...
    try:
        ...
        driver.get(url)
        # Attendre que les éléments se chargent
        WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.CSS_SELECTOR, "body > div.global > div.article")))
        # Récupérer les éléments nécessaires
        article = driver.find_element(By.CSS_SELECTOR, "body > div.global > div.article")
        ...
        if date_format in date :
            ...
            try:
                description2 = article.find_element(By.CSS_SELECTOR, "div.article_corps").text.strip()
            except Exception as e:
                print(f"Erreur lors de la récupération de la description : {e}")
                
            try:
                description1 = article.find_element(By.CSS_SELECTOR, "div.chapo").text.strip()
            except Exception as e:
                print(f"Erreur lors de la récupération de la description : {e}")
            ...
            article_info = {
                ...
                "date": date_format,
                "tag" : tag,
                "source_link": "https://www.bladi.net/maroc.html"
            }
...
def main17(date,driver):
    ...
    try:
        ...
        for url in tqdm(article_urls, desc=f"Scraping des articles sur https://www.bladi.net/maroc.html à la date {date} "):
        ...
        print(f"Une erreur s'est produite lors de la récupération https://www.bladi.net/maroc.html' : {e}")
